        ...
        if (settings.parallax) {
            ...
            $window
                ...
                .on('resize.overflow_parallax', function () {
                    ...
                    if (!skel.isActive('wide') || skel.isActive('narrow')) {
...
(function ($) {
    ...
    function postContactToGoogle() {
        var $name = $('#name'),
            ...
            form_id = "1NsUHhawz5G_HZ-g0BEQR0Yza98E29CVFz9lvNCoYSgM";

        if (($name.val() !== "") && ($email.val() !== "") && (($message.val() !== "") && (validateEmail($email.val())))) {
            $.ajax({
                url: "https://docs.google.com/forms/d/" + form_id + "/formResponse",
                data: {
                    "entry.1763173613": $name.val(),
                    "entry.702749593": $email.val(),
                    "entry.774789590": $message.val()
                },
                type: "POST",
                dataType: "xml",
                statusCode: {
